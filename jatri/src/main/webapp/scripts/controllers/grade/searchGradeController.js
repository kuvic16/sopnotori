app.registerCtrl('SearchGradeController', function($scope, $http, GradeResource,$routeParams, PagerService ) {
    ...
    $scope.performSearch = function() {
        ...
        GradeResource.queryAll({start: $scope.currentPage, max : $scope.pageSize, name: $scope.search.name, code: $scope.search.code},successCallback, errorCallback);
    };
    ...
    $scope.remove = function(name, id) {
    	$.confirm({
            ...
            confirm: function(button) {
                ...
                GradeResource.remove({GradeId: id}, successCallback, errorCallback);
            },
    ...
    if (typeof $routeParams.desc !== "undefined") {
    	$scope.search.code = $routeParams.code;
    }
