app.registerCtrl('SearchDonorController', function($scope, $http, DonorResource,$routeParams, UdvResource, PagerService,
		rexValidation) {
        ...
        DonorResource.queryAll(
        						{
        							...
        							hoEmail:		$scope.search.hoEmail,
        							donorTypeUdvId:	$scope.search.donorTypeUdvId
        						},
    ...
    $scope.clearSearch = function() {
    	...
    	$scope.search.hoEmail=null;
    	$scope.search.donorTypeUdvId="";
    };
    ...
    $scope.remove = function(name, id) {
    	$.confirm({
            ...
            confirm: function(button) {
                ...
                DonorResource.remove({DonorId: id}, successCallback, errorCallback);
            },
    ...
    if (typeof $routeParams.name !== "undefined") {
    	$scope.search.name = $routeParams.code;
    }
    
    if (typeof $routeParams.desc !== "undefined") {
    	$scope.search.description = $routeParams.name;
    }
