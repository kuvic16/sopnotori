app.registerCtrl('SearchEducationTypeController', function($scope, $http, EducationTypeResource,$routeParams, PagerService ) {
    ...
    $scope.performSearch = function() {
        ...
        EducationTypeResource.queryAll({start: $scope.currentPage, max : $scope.pageSize, name: $scope.search.name, scale: $scope.search.scale},successCallback, errorCallback);
    };
    ...
    $scope.remove = function(name, id) {
    	$.confirm({
            ...
            confirm: function(button) {
                ...
                EducationTypeResource.remove({EducationTypeId: id}, successCallback, errorCallback);
            },
    ...
    if (typeof $routeParams.scale !== "undefined") {
        $scope.search.description = $routeParams.scale;
    }
