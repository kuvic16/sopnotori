...
public abstract class PersistableEntity implements Serializable{	
	...
	@GenericGenerator(name = "uids", strategy = "com.okrur.st.jt.util.IdGenerator", parameters = { @Parameter(name = "uuid_gen_strategy_class",  value = "com.brac.ehealth.util.IdGenerator") })
