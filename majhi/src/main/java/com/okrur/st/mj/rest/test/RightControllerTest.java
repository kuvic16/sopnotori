package com.okrur.st.mj.rest.test;
...
public class RightControllerTest {
	...
	@Rule
	public Destination destination = new Destination(this, "http://localhost:8080/emis/rest/udv");

	@Context
	private Response response;
	
	@HttpTest (method = Method.GET, path="/category")
