app.registerCtrl('SearchRoleController', function($scope, $http, RoleResource,$routeParams, PagerService ) {
    ...
    $scope.performSearch = function() {
        ...
        RoleResource.queryAll({start: $scope.currentPage, max : $scope.pageSize, name: $scope.search.name, desc: $scope.search.description},successCallback, errorCallback);
    };
    ...
    $scope.remove = function(role_name, role_id) {
    	$.confirm({
            ...
            confirm: function(button) {
                ...
                RoleResource.remove({RoleId: role_id}, successCallback, errorCallback);
            },
    ...
    var init = function () {
    	$.getScript("scripts/services/RoleFactory.js");
    };
