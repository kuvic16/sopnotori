app.registerCtrl('SearchGradingSystemController', function($scope, $http, GradingSystemResource,$routeParams, PagerService ) {
    ...
    $scope.performSearch = function() {
        ...
        GradingSystemResource.queryAll({start: $scope.currentPage, max : $scope.pageSize, name: $scope.search.name, scale: $scope.search.scale},successCallback, errorCallback);
    };
    ...
    $scope.remove = function(name, id) {
    	$.confirm({
            ...
            confirm: function(button) {
                ...
                GradingSystemResource.remove({GradingSystemId: id}, successCallback, errorCallback);
            },
